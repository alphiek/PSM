...
export const Icons = ({ name }) => {
    ...
    case "bars":
      return (
        <Icon>
          ...
          <circle class="cls-1" cx="15" cy="15" r="15" fill={colors.slate}/>
          <g fill={colors.tan}>
  <path class="cls-2" d="M7.46,6.76H9V10.3l-.9.89a.36.36,0,0,0-.12.27.42.42,0,0,0,.12.26,8.41,8.41,0,0,0,2.65,0,.33.33,0,0,0,.11-.27.36.36,
  ...
  <path class="cls-2" d="M23.62,14.76H6.38a.38.38,0,0,0-.38.38.37.37,0,0,0,.38.37h.31v7.75H9.11L9,23.51a.42.42,0,0,0,0,.29.37.37,0,0,
    ...
    case "extensions":
      return (
        <Icon>
          ...
          <circle class="cls-1" cx="15" cy="15" r="15" fill={colors.slate}/>
  <g fill={colors.tan}>
    <rect class="cls-2" x="17.36" y="6.44" width="1.43" height="0.71"/>
    <rect class="cls-2" x="20.17" y="7.19" width="0.71" height="1.43" transform="translate(1.26 18.51) rotate(-49.9)"/>
    <rect class="cls-2" x="19.44" y="21.19" width="1.43" height="0.71"/>
    <rect class="cls-2" x="14.5" y="6.44" width="1.43" height="0.71"/>
    <rect class="cls-2" x="24.24" y="16.71" width="0.71" height="1.43"/>
    <rect class="cls-2" x="24.24" y="13.85" width="0.71" height="1.43"/>
    <rect class="cls-2" x="22.35" y="9.03" width="0.71" height="1.43" transform="translate(0.63 20.84) rotate(-49.91)"/>
    <polygon class="cls-2" points="24.57 10.85 24.11 11.39 24.24 11.5 24.24 12.43 24.96 12.43 24.96 11.17 24.57 10.85"/>
    <rect class="cls-2" x="24.24" y="19.56" width="0.71" height="1.43"/>
    <rect class="cls-2" x="22.3" y="21.19" width="1.43" height="0.71"/>
    <path class="cls-2" d="M17.75,12.84l.46-.55-6.1-5.13h1V6.44H11.65v.33l-.52-.44L5.39,11.17h0L4.06,12.29l.46.55.87-.74v9.8H18v-.71H16.88V12.1ZM16.16,11.5v9.69h-3.8V16.73H9.91v4.46H6.1V11.5l5-4.23Z"/>
    <rect class="cls-2" x="13.37" y="13.34" width="1.58" height="2.36"/>
    <rect class="cls-2" x="7.31" y="13.34" width="1.58" height="2.36"/>
  </g>
            </svg>
        </Icon>
      )
